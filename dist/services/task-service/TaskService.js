        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, events.emit("newTask", task)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function updateTaskById(id, changes) {
    storage.tasks.forEach(function (task) {
        ...
        events.emit("taskChanged", { task: task, changes: changes });
    });
}
function addComment(task_id, comment) {
    ...
    events.emit("newComment", { task: task, comment: comment });
}
;
var TaskService = {
    addTask: addTask,
